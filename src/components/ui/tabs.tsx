...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={`${cn(tabsListVariants({ variant }), className)} minebox-shadow !bg-linear-to-b from-card to-card-dark gap-2`}
      {...props}
    />
  )
}
