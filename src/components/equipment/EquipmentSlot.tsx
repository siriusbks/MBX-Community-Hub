        ...
        <TooltipTrigger asChild>
          <span className="flex h-full w-full">
            {equippedItem ? (
              <RarityBorder
                rarity={rarityId}
                className="flex aspect-square size-full items-center justify-center border-[5px] transition-transform duration-200 group-hover:scale-110"
              >
            ...
            {equippedItem?.level != null &&
              playerLevel < equippedItem.level && (
                <div className="absolute inset-x-0 top-1 flex justify-center">
                  <span className="mb-0.5 inline-flex items-center gap-1 rounded-t bg-black/70 px-1.5 py-0.5 text-[8px] text-red-400 3xl:text-[8px]">
                    Level Too Low
                  </span>
                </div>
              )}
