...
import { Map, Shield, User, Github } from 'lucide-react';
      ...
      <footer className="border-t border-gray-700 mt-16">
        <div className="container mx-auto px-4 py-6 text-center text-gray-400">
          ...
          <p className="text-xs mt-2">
            If you have any problems, go <a className="font-bold" href="https://github.com/siriusbks/MBX-Community-Hub/issues" target="_blank">here</a> to report them.
          </p>
        </div>
      </footer>
    </div>
