...
const lotteryDrops = {
  ...
  pirate_hourglass: 1,
  pirate_shark_plaque: 1,
  pirate_gold_pile_large: 1,
  pirate_helm_wall: 1,
  pirate_helm_floor: 1,
  pirate_treasure_map: 1,
  lemonade_dispenser: 1,
  lemonade_balloon_post: 1,
  paint_coastal_path: 1,
  paint_sunset: 1,
  paint_sea_wave: 1.87,
  paint_awake: 1,
  paint_red_tower: 1,
  ...
  pirate_treasure_chest_decor: 1,
  paint_guiding_glow: 1,
  jungles_heart_helmet: 1,
  jungles_heart_chestplate: 1,
  jungles_heart_leggings: 1,
  jungles_heart_boots: 1,
  jungles_heart_sword: 1,
  jungles_heart_bow: 1,
  harvester_jungles_heart: 1,
  octopus_hat: 1,
  octopus_backpack: 1,
  octopus_staff: 1,
  water_gun_2: 1,
